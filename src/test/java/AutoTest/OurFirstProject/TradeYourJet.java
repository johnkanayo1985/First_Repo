...
public class TradeYourJet extends driver {
	...
	driver.findElement(By.id("q1")).sendKeys("1200000");
		
	}

	@When("^I enter purchase price$")
	public void i_enter_purchase_price() throws Throwable {
	driver.findElement(By.id("q2")).sendKeys("4000000");
	}
	...
	String Expected ="Thank you for your Message! We will get in touch as soon as possible.";
